...
// Códigos series INE — IPC grupos ECOICOP (índice general, nacional, base 2021)
const INE_SERIES = {
  "Alimentación": "IPC206449",
  "Energía":      "IPC206453",
  "Transporte":   "IPC206456",
  "Ocio":         "IPC206458",
};
...
// ── HOOK: IPC — API JSON INEbase (sin autenticación) ──────────────────────────
function useIPC() {
    ...
    (async () => {
      try {
        const entries = await Promise.all(
          Object.entries(INE_SERIES).map(async ([nombre, codigo]) => {
            const res = await fetch(
              `https://servicios.ine.es/wstempus/js/ES/DATOS_SERIE/${codigo}?nult=36`
            );
